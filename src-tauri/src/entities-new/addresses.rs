    ...
    pub async fn create_address(&self, address: &Address) -> Result<Address> {
        ...
        Ok(sqlx::query_as!(
            ...
            r#"INSERT INTO addresses (
                    id, user_id, contact_id, organization_id, account_id, type, status,
                    ...
                    organization_id AS "organization_id: _", account_id AS "account_id: _",
                    type AS "type_: AddressType", status as "status: AddressStatus",
                    street, city, state, postal_code, country, country_code, latitude, longitude,
    ...
    pub async fn get_address_by_id(&self, id: &Uuid) -> Result<Option<Address>> {
        ...
        Ok(sqlx::query_as!(
            ...
            r#"SELECT 
                    id AS "id: _", user_id AS "user_id: _", contact_id AS "contact_id: _",
                    organization_id AS "organization_id: _", account_id AS "account_id: _",
                    type AS "type_: AddressType", status as "status: AddressStatus", street, city, state,
    ...
    pub async fn update_address(&self, address: &Address) -> Result<Address> {
        ...
        Ok(sqlx::query_as!(
            ...
            r#"UPDATE addresses SET 
                user_id = ?, contact_id = ?, organization_id = ?, account_id = ?,
                type = ?, status = ?, street = ?, city = ?, state = ?, postal_code = ?,
