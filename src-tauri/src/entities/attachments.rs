...
impl DatabaseManager {
    ...
    pub async fn create_attachment(&self, attachment: &CreateAttachment) -> Result<Attachment> {
        ...
        Ok(sqlx::query_as!(
            ...
            r#"INSERT INTO attachments (
                    id, workspace_id, message_id, file_id, attachment_type, url, metadata, created_at, updated_at
            ) VALUES (
            ?, ?, ?, ?, ?, ?, ?, ?, ?
            ) RETURNING 
               id as "id: _", workspace_id as "workspace_id: _", message_id as "message_id: _", file_id as "file_id: _", 
               attachment_type as "attachment_type: _", url, metadata as "metadata: _",
    ...
    pub async fn get_attachment_by_id(&self, id: &Uuid) -> Result<Option<Attachment>> {
        ...
        Ok(sqlx::query_as!(
            ...
            r#"SELECT 
                    ...
                    file_id as "file_id: _", attachment_type as "attachment_type: _", url, metadata as "metadata: _",
                    created_at as "created_at: _", updated_at as "updated_at: _"
    ...
    pub async fn list_attachments(&self, filter: &AttachmentFilter) -> Result<Vec<Attachment>> {
        ...
        let mut qb: QueryBuilder<Sqlite> = QueryBuilder::new(   
            r#"SELECT id, workspace_id, message_id, file_id, attachment_type AS attachment_type, url, metadata,
        ...
        if let Some(attachment_type) = &filter.attachment_type {
            add_where(&mut qb);
            qb.push("attachment_type = ");
            qb.push_bind(*attachment_type as i32);
        }
    ...
    pub async fn update_attachment(self, attachment: &Attachment) -> Result<()> {
        ...
        let result = sqlx::query!(
            "UPDATE attachments SET
                workspace_id = ?, message_id = ?, file_id = ?, attachment_type = ?,
    ...
    pub async fn get_by_message(self, message_id: &Uuid) -> Result<Vec<Attachment>> {
        let filter = AttachmentFilter {
            ...
            file_id: None,
            attachment_type: Some(AttachmentType::File),    
            search_term: None,
            limit: None,
            offset: None,
        };
    ...
    pub async fn get_images_by_message(self, message_id: &Uuid) -> Result<Vec<Attachment>> {
        let filter = AttachmentFilter {
            ...
            message_id: Some(*message_id),
            file_id: None,
            attachment_type: Some(AttachmentType::Image),
            search_term: None,
            limit: None,
            offset: None,
        };
    ...
    pub async fn get_videos_by_message(self, message_id: &Uuid) -> Result<Vec<Attachment>> {
        let filter = AttachmentFilter {
            ...
            message_id: Some(*message_id),
            file_id: None,
            attachment_type: Some(AttachmentType::Video),
            search_term: None,
            limit: None,
            offset: None,
        };
    ...
    pub async fn get_audio_by_message(self, message_id: &Uuid) -> Result<Vec<Attachment>> {
        let filter = AttachmentFilter {
            ...
            message_id: Some(*message_id),
            file_id: None,
            attachment_type: Some(AttachmentType::Audio),
            search_term: None,
            limit: None,
            offset: None,
        };
    ...
    pub async fn get_links_by_message(self, message_id: &Uuid) -> Result<Vec<Attachment>> {
        let filter = AttachmentFilter {
            ...
            message_id: Some(*message_id),
            file_id: None,
            attachment_type: Some(AttachmentType::Link),
            search_term: None,
            limit: None,
            offset: None,
        };
    ...
    pub async fn count_by_type_and_message(
        ...
        Ok(sqlx::query_scalar!(
            "SELECT COUNT(*) as count FROM attachments WHERE message_id = ? AND attachment_type = ?",
            message_id,
            attachment_type,
        )
        .fetch_one(&self.pool)
