        ...
        <div className="bg-card rounded-lg border shadow-sm">
          ...
          <div className="p-4 space-y-2 overflow-auto max-h-[calc(50vh-8rem)]">
            {recentConversations.slice(0, 5).map((conv) => (
              <div
                key={conv.id}
                className="p-3 hover:bg-accent/50 rounded-md cursor-pointer"
                onClick={() => navigate('/communications')}
              >
        ...
        <div className="bg-card rounded-lg border shadow-sm">
          ...
          <div className="p-4 space-y-2 overflow-auto max-h-[calc(50vh-8rem)]">
            ...
            {todaysAgenda.length > 0 ? (
              todaysAgenda.slice(0, 5).map((event) => (
                <div
                  key={event.id}
                  className="p-3 hover:bg-accent/50 rounded-md cursor-pointer border-l-2 border-primary"
                  onClick={() => navigate('/calendar')}
                >
                  <div className="flex justify-between items-start">
            ...
            {recentDocuments.slice(0, 5).map((doc) => (
              ...
              >
                ...
                <div className="mt-1 text-sm text-muted-foreground">
                  {doc.type === 'folder'
                    ? `${doc.items} items • Modified ${doc.modified}`
